...
3. **ALWAYS use Motion library** for animations (NOT framer-motion)
...
❌ **DON'T:**
- Use framer-motion (use motion library)
...
✅ **DO:**
- Use Tailwind v3 with CSS custom properties
- Import Inter font
- Include base styles
- Use Shadcn components
- Use Lucide icons
- Add Motion library to everything
